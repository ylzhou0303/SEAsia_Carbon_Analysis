...
condition = 'cloud';
season = 'spring';  % for Talang, enter spring, summer, fall or winter; for SG, just leave it empty

matname = ['PARs_',location,'_',condition,'.mat'];
load (['F:\NTU\Research\Photodegradation experiment\photodeg modelling\',matname]);
...
save(['F:\NTU\Research\Photodegradation experiment\photodeg modelling\model results\',savename]);
